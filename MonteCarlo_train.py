...
def parse_args():
    ...
    parser.add_argument('--pai', type=bool, default=True, help='run on pai')
        ...
        for e in range(args.epochs):
            ...
            while True:
                try:
                    ...
                    if ((not args.pai) and (step % (10 * int(args.update_steps)) == 0)) or (args.pai and ((step+1) % (10 * int(args.update_steps)) == 0)):
